# Top-Tier CLI Parity Gap Summary

## Closed in this round

- tool runtime telemetry
- permission explanation surface
- background task registry
- background task output reader
- verification agent entrypoint
- review-changes review agent entrypoint
- workflow script runner
- workflow dry-run planning
- workflow show/list command
- task notifications
- task briefings
- history picker / reuse command
