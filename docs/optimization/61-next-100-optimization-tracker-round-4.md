# Next 100 Optimization Tracker Round 4

## Scope

第四轮 100 项优化不再围绕“补齐诊断字段”，而是开始把前三轮攒下来的 operator surfaces 真正统一成可持续演进的 workspace：

- shared workspace rendering and inspector composition
- richer navigation across tasks / memory / reviews / diagnostics
- deeper remote/browser execution and workflow productization
...
- `[x]` 001 shared workspace text renderer
- `[x]` 002 workspace section / metadata formatting tests
- `[x]` 003 task detail adopts shared workspace layout
- `[x]` 004 task output adopts shared workspace layout
- `[x]` 005 transcript workspace adopts shared workspace layout
