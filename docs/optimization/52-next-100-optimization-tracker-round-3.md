# Next 100 Optimization Tracker Round 3

## Scope

第三轮 100 项优化不再继续补“基础可观测字段”，而是转向第二轮 closeout 里明确剩下的三条主线：

- panel / dialog / pager style TUI primitives
- unified runtime timeline and operator workspace
- browser / remote / authenticated workflow depth
...
- `[x]` 001 unified runtime timeline event model
- `[x]` 002 runtime timeline ordering and folding helper
- `[x]` 003 brief command runtime timeline section
