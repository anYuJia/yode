...
- `[ ] 026 /tasks filters by kind and status`
- `[ ] 027 /tasks tail follow mode`
- `[ ] 028 notification severity classes for tasks`
...
- `[ ] 041 permission explanation links to effective rule`
...
- `[ ] 050 safety-focused doctor checks`
...
- `[ ] 081 release preflight command`
- `[ ] 082 version / tag consistency doctor check`
