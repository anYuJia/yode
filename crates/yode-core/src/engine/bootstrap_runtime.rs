...
impl AgentEngine {
    pub fn new(
        ...
        Self {
            ...
            turn_budget_started_at: None,
            turn_step_count: 0,
            turn_budget_max_tool_calls: 40,
            turn_budget_max_steps: 0,
            turn_budget_max_wall_secs: 0,
            ...
            context_collapse_operations: 0,
            last_context_collapse_at: None,
            last_context_collapse_artifact_path: None,
            last_context_collapse_saved_chars: 0,
            context_collapse_saved_chars_total: 0,
