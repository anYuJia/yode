...
impl AgentEngine {
    ...
    pub fn runtime_state(&self) -> EngineRuntimeState {
        ...
        EngineRuntimeState {
            ...
            prompt_cache,
            cost: CostRuntimeState {
                model: self.cost_tracker.model().to_string(),
                ...
                api_calls: self.cost_tracker.usage().api_calls,
                tool_calls: self.cost_tracker.usage().tool_calls,
                session_duration_ms: self.cost_tracker.session_duration().as_millis() as u64,
                api_duration_ms: self.cost_tracker.total_api_duration_ms(),
                tool_duration_ms: self.cost_tracker.total_tool_duration_ms(),
            },
    ...
    pub(super) async fn build_tool_context(
        ...
        ToolContext {
            ...
            team_runtime: Some(Arc::clone(&self.team_runtime_manager)),
            ...
            skill_invocations: Some(Arc::clone(&self.skill_invocation_store)),
