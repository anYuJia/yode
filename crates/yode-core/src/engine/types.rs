...
pub struct EngineRuntimeState {
    ...
    pub stop_hook_continue_count: u32,
    pub last_stop_hook_continue_reason: Option<String>,
    ...
    pub last_microcompact_media_saved_chars: u64,
    pub microcompact_media_removed_total: u64,
    pub microcompact_media_saved_chars_total: u64,
...
pub struct PromptCacheRuntimeState {
    ...
    pub last_turn_cache_edit_deletions: Option<u32>,
    pub last_turn_cache_deleted_tokens: Option<u32>,
    pub pending_cache_edit_refs: u32,
    pub pinned_cache_edit_refs: u32,
    pub pending_cache_edit_ref_values: Vec<String>,
    pub pinned_cache_edit_ref_values: Vec<String>,
    pub prompt_cache_break_count: u32,
    pub last_prompt_cache_break_reason: Option<String>,
    pub last_prompt_cache_break_at: Option<String>,
    pub last_prompt_cache_expected_drop_reason: Option<String>,
    pub last_prompt_cache_change_summary: Option<String>,
    pub last_prompt_cache_transition_kind: Option<String>,
    pub last_prompt_cache_transition_reason: Option<String>,
    pub last_prompt_cache_prefix_hash: Option<String>,
    pub last_prompt_cache_system_hash: Option<String>,
    pub last_prompt_cache_restore_hash: Option<String>,
    pub last_prompt_cache_tool_hash: Option<String>,
    pub last_prompt_cache_message_hash: Option<String>,
    pub last_prompt_cache_diff_artifact_path: Option<String>,
    pub last_prompt_cache_diff_summary: Option<String>,
    pub reported_turns: u32,
    pub cache_write_turns: u32,
    pub cache_read_turns: u32,
    pub cache_edit_turns: u32,
    pub cache_write_tokens_total: u64,
    pub cache_read_tokens_total: u64,
    pub cache_edit_deletions_total: u64,
    pub cache_deleted_tokens_total: u64,
}
