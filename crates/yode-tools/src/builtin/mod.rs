...
pub fn register_builtin_tools(registry: &ToolRegistry) {
    ...
    registry.register(Arc::new(todo::TaskUpdateTool));
    registry.register(Arc::new(todo::TaskStopTool));
    ...
    registry.register(Arc::new(remote_runtime::RemoteQueueResultTool));
    registry.register(Arc::new(remote_runtime::RemoteTransportControlTool));
