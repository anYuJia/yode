...
impl Tool for EditFileTool {
    ...
    fn description(&self) -> &str {
        "Edit a file by replacing exact string matches. Finds old_string in the file and replaces it with new_string. The old_string must be unique unless replace_all is true."
    }
