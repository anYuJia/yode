...
function getFileIcon(filename: string) {
  ...
  // Helper render of SVG inline based on file identity
  const renderSvgBody = () => {
    // Specialized cases first
    ...
    switch (ext) {
      ...
      default:
        ...
        // General text fallback code file
        return (
          <>
            <rect x="2" y="1.5" width="12" height="13" rx="1.5" />
...
function PermissionActions({
  ...
  // Reset selectedIndex to 0 when a new permission request arrives
  useEffect(() => {
    setSelectedIndex(0);
  }, [item.id]);

  // Focus the option when selection index or permission request changes
  useEffect(() => {
