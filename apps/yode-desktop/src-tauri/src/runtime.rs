...
use crate::protocol::{
    ...
    ConfigurationUpdateRequest, DesktopActionResult, DesktopEvent, DesktopMcpServer,
    DesktopMcpServerStatus, DesktopMcpState, DesktopSettingSetRequest, DesktopSettingValue,
